...
function cosmology_scripts()
{
    ...
    wp_enqueue_script('jquery3', get_theme_file_uri('/js/jquery-3.2.1.min.js'), [], null);
    wp_enqueue_script('popper', get_theme_file_uri('/js/popper.min.js'), [], null);
    wp_enqueue_script('bootstrap', get_theme_file_uri('/js/bootstrap.min.js'), [], null);
